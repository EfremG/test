...
static void create_stereo_buttons(cv::String str,stereoCam *stereo){
	...
	//cv::createButton("Show Calibrated Picture",cameraJaiGo::buttonShowRectication,stereo,CV_PUSH_BUTTON,0);
...
public:
	...
	windowJaiGo(ArvCamera* cam);
	~windowJaiGo();
	ArvCamera* camera;
	void buttonAutoExposure(int stat,void *data);
	void buttonAutoWhiteBalance(int stat,void *data);
	void buttonShowRectication(int stat,void *data);
	void buttonTakePicture(int stat,void *data);
	void buttonRunStream(int stat,void *data);
	void buttonSavePicture(int stat,void *data);
	void buttonWhiteBalance(int stat,void *data);
	void buttonTriggerActivation(int stat,void *data);
	void buttonSoftwareTrigger(int stat,void *data);
	void buttonBinning(int stat,void *data);

	void trackbarExposureTime(int pos, void* data);

	void createWindow(cv::String str);
};

void windowJaiGo::windowJaiGo(ArvCamera* cam1){
	camera = cam1;


}

void windowJaiGo::createWindow(cv::String str){
	cv::namedWindow(str,cv::WINDOW_NORMAL);

	cv::createButton("Auto Exposure",windowJaiGo::buttonAutoExposure,this,CV_CHECKBOX,1);
}

void  windowJaiGo::buttonAutoExposure(int stat,void *data){
